<template>
    <div class="filter">
      <Calendar id="start-24h" v-model="startTime" showTime hourFormat="24" @change="handleStartTimeChange" />
      <i class="pi pi-arrow-right arrow" style="color: #708090"></i>
      <Calendar id="end-24h" v-model="endTime" showTime hourFormat="24" @change="handleEndTimeChange" />
...
const emit = defineEmits(['update:startTime', 'update:endTime', 'update:resolution'])
